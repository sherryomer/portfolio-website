...
const projects = [
  {
    ...
    description:
      "SleepApply is a full-stack job-search operating system — job discovery via Google Jobs, Kanban-style application tracking, AI-powered CV scoring and ATS optimization, per-job CV tailoring, and Auto Apply, which drafts cover letters and screening responses and submits email-based applications autonomously. Powered by GPT-5.",
    tech: ["TypeScript", "Next.js 14", "Supabase", "NextAuth", "OpenAI GPT-5", "SerpAPI"],
    github: null,
    liveUrl: "https://www.sleepapply.org",
    isPrivate: true,
    color: "cyan",
    category: "Full-Stack",
    featured: true,
  ...
  },
  {
    ...
    subtitle: "Cross-Platform Prompt Refinement",
    description:
      "PromptOptimizer is a cross-platform prompt-refinement product — a scoring and rewrite engine shipped as an MCP server, VS Code/Cursor and browser extensions (ChatGPT, Claude, Gemini), and a CLI, backed by a metered Next.js SaaS with Stripe-based license activation.",
    tech: ["TypeScript", "Next.js", "Turborepo", "MCP", "GLM (Z.ai)", "Stripe"],
    github: null,
    liveUrl: "https://promptoptimizer-alpha.vercel.app",
    isPrivate: true,
    color: "violet",
  ...
  },
  {
    ...
    github: null,
    liveUrl: "https://eveon-chatbot.vercel.app/",
    isPrivate: true,
    color: "amber",
    category: "Chatbot",
    featured: false,
